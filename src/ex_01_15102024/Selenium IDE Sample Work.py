...
class TestVerifyTitleName():
    ...
    def test_verifyTitleName(self):
        ...
        self.driver.find_element(By.CSS_SELECTOR, ".form-horizontal > .form-group:nth-child(2)").click()
        self.driver.find_element(By.CSS_SELECTOR, ".col-sm-offset-3").click()
        self.driver.find_element(By.CSS_SELECTOR, "#login .row").click()
